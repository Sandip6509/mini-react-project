...
function App() {
  ...
  const appKey = String(import.meta.env.VITE_WEATHER_APP_KEY)
  ...
  return (
    <div className='app flex flex-col items-center'>
      ...
      {weather && (
        <div className="card bg-purple-500 text-white w-[220px] h-[350px] flex flex-col justify-center items-center mt-10 rounded-xl">
